...
def test_set_domain_name_success(client):
    ...
    response = client.post('api/v1/dhcp_config/domainName',
...
def test_set_begin_ip_range_success(client):
    ...
    response = client.post('api/v1/dhcp_config/beginIpRange',
                           headers=auth_header, json=data)
    json_response = json.loads(response.data.decode())
    assert response.status_code == 200
...
def test_set_end_ip_range_success(client):
    ...
    response = client.post('api/v1/dhcp_config/endIpRange',
                           headers=auth_header, json=data)
    json_response = json.loads(response.data.decode())
    assert response.status_code == 200
...
def test_set_lease_time_success(client):
    ...
    response = client.post('api/v1/dhcp_config/leaseTime',
                           headers=auth_header, json=data)
    json_response = json.loads(response.data.decode())
    assert response.status_code == 200
...
def test_set_hostname_success(client):
    ...
    response = client.post('api/v1/local_network/hostname',
                           headers=auth_header, json=data)
    json_response = json.loads(response.data.decode())
    assert response.status_code == 200
...
def test_set_mtu_success(client):
    ...
    response = client.post('api/v1/local_network/mtu',
                           headers=auth_header, json=data)
    json_response = json.loads(response.data.decode())
    assert response.status_code == 200
