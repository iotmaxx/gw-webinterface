...
function WirelessNetworkSimConfigForm({ submit }) {
  ...
  return (
    <FormWrapper onSubmit={formik.handleSubmit}>
      ...
      />
      <FormFieldError touched={formik.touched.pin} errors={formik.errors.pin} />

      <label htmlFor="enableRoaming">
        Roaming enabled
        <CheckboxWrapper
          name="enableRoaming"
      ...
      <input
        ...
        {...formik.getFieldProps('apn')}
      />
      <FormFieldError touched={formik.touched.apn} errors={formik.errors.apn} />
